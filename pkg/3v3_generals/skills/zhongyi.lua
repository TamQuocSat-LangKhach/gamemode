...
zhongyi:addEffect('active', {
  ...
  on_use = function(self, room, effect)
    ...
    player:addToPile(zhongyi.name, effect.cards, true, zhongyi.name, player.id)
  end,
})
...
zhongyi:addEffect(fk.DamageCaused, {
  ...
  on_use = function(self, event, target, player, data)
    ...
    player:broadcastSkillInvoke(zhongyi.name)
    room:notifySkillInvoked(player, zhongyi.name, "offensive")
